...
def singleItemSearch(encodedData, text):
    print("*** Starting Single Item Scan ***")
    global encodeMap
    foundValues = list()
    startTime = perf_counter()
    for elem in encodedData:
        if (elem in encodeMap.values()):
            foundValues.append(encodeMap[elem].decode("utf-8"))
        else:
            continue
...
if __name__ == "__main__":
    ...
    # print(time)
    # time = singleItemSearch(encList, "toyota12")
    # print(time)
    # print()
    # time = singleItemSearch(encList, "dodge123")
    # print(time)
    ...
    # Data Size Times
    #   8B --> 0.00013885300722904503
    #  64B --> 0.00012462001177482307
    # 256B --> 0.0001767530047800392

    # Searching Times
    # Prefix Exists -------------> 1.6236997907981277e-05
    # Prefix Doesnt exist -------> 9.587995009496808e-06
    # Single Item Exists --------> 9.316951036453247e-06
    # Single Item Doesnt Exist --> 9.48301749303937e-06
